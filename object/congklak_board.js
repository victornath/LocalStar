...
class Congklak
{
    constructor(){
        ...
        board.position.set(13,height+(board_properties.height/2),0)
        ...
        corner_l.position.set(30,height+(board_properties.height/2),0)
        const corner_r = new THREE.Mesh(geo_corner_r, wood)
        corner_r.position.set(-4,height+(board_properties.height/2),0)
