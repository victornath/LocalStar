...
class Tribune_mid
{
    constructor(){
        ...
        base.position.set(16.25,height+(base_properties.height/2),12.5)
        ...
        stair.position.set(16.25,height+(stair_properties.height/2),0)
        ...
        stair2.position.set(16.25,height+(stair_properties.height/2),-12.5)
        height += stair_properties.height
        ...
        border_sr.position.set(-8.75,33.5+border_sr_properties.height/2,12.5)
        ...
        border_s1.position.set(-8.75,border_s1_properties.height/2,12.5)
        ...
        border_s2.position.set(-8.75,37.5+border_s2_properties.height/2,-18.5)
