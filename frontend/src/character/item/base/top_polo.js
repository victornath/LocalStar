...
class top_polo {
    constructor(material2) {
        ...
        shirt[12] = new THREE.Mesh(plane_shirt, material2)
        shirt[12].position.set(5, 2 + 8.35, 0)
        shirt[12].rotation.x = -Math.PI / 2
        shirt[13] = new THREE.Mesh(plane_shirt, material2)
        ...
        // Body
        this.object[3].push(shirt[0], shirt[1], shirt[2], shirt[3], shirt[12], shirt[13], shirt[14], shirt[15], shirt[16], shirt[17])
