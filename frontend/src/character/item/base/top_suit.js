...
class top_suit {
    constructor(material, material2) {
        ...
        plane_shirt = new THREE.PlaneGeometry(4, 7)
        shirt[16] = new THREE.Mesh(plane_shirt, material2)
        shirt[16].rotation.z = Math.PI / 4
        shirt[16].rotation.x = -Math.PI / 4
        shirt[16].position.set(-4, 10, 5.15)
        shirt[17] = new THREE.Mesh(plane_shirt, material2)
        shirt[17].rotation.z = -Math.PI / 4
        shirt[17].rotation.x = -Math.PI / 4
        shirt[17].position.set(4, 10, 5.15)

        plane_shirt = new THREE.PlaneGeometry(5, 5)
        shirt[18] = new THREE.Mesh(plane_shirt, material)
        shirt[18].rotation.z = -Math.PI / 4
        shirt[18].position.set(-1.5, 9, 5.2)
        let group = new THREE.Group()
        let temp = new THREE.Mesh(plane_shirt, material)
        temp.rotation.z = -Math.PI / 4
        group.add(temp)
        shirt[19] = group
        shirt[19].scale.set(0.5, 1.5, 1)
        shirt[19].position.set(-1.5, 1.5, 5.2)
        ...
        // Body
        this.object[3].push(shirt[0], shirt[1], shirt[2], shirt[3], shirt[12], shirt[13], shirt[14], shirt[15], shirt[16], shirt[17], shirt[18], shirt[19])
