            ...
            <div className="help-banner">
                <div class="container px-4 px-lg-5 help-content">
                    <div class="row gx-4 gx-lg-5">
                        ...
                        <div class="col-6 justify-content-center">
                            <img class="img-fluid center" src="/images/gobaksodor_1.png"></img><br></br><br></br>
                            <img class="img-fluid center" src="/images/gobaksodor_2.png"></img><br></br><br></br>
                            <img class="img-fluid center" src="/images/gobaksodor_3.png"></img><br></br><br></br>
                        </div>
                    </div>
                </div>
            </div>
